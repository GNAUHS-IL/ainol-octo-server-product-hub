...
| `10-cross-module-quickref.md` | 多个相关 `area/*` | 跨模块高频问题速查：Bot、Webhook、Card、OIDC/Token、文件、群/Thread、配置/部署 | V1 已补源码证据 |
...
## 更新记录
- 2026-09-09：已吸收目标仓 `98d20920` 的 Project P2 / AI Team Agent 分组 / 全员群 / sidebar project_id / 项目置顶增量，重点更新 01/02/03/04/05/06/07/08/10。
