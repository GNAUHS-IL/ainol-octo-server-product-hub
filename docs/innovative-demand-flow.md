...
4. 安全/权限/证据冲突 → blocked，由产品运营负责人决定补证据、等待恢复或发起人工复核确认
```
...
### 源码 / 知识库归因
- area/*：按证据最小化使用，主 area + 必要且有依据的关联 area；
- 已查路径：
...
status/blocked
↓
产品运营负责人记录脱敏说明，并决定是否需要人工复核确认
↓
等待恢复 / 补证据 / 由产品运营负责人关闭仲裁
```
...
5. **Blocked-safe-stop**：安全、权限、限流、证据冲突不丢给需求管理员，由产品运营负责人判断是否补证据、等待恢复或发起人工复核确认。
