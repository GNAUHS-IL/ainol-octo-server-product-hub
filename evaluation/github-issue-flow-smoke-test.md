...
2. Classify it into type / priority / area / status labels.
...
| 2026-09-05 23:59 +0800 | Update labels after triage | Pass | labels: `type/feature`, `priority/P2`, `status/triaged`, `area/bot-agent`, `pm/needs-prd`, `source/evaluation` |
...
- Natural language feedback can be converted into issue title/body/labels.
