...
2. Classify it into issue-first type / priority / status / area labels.
...
| 2026-09-05 23:59 +0800 | Update labels after triage | Pass | labels: `type/feature`, `priority/P2`, `status/done`, `area/bot-agent` |
